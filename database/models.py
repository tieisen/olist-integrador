...
class Empresa(Base):    
    ...
    olist_admin_email = Column(String, nullable=False)
    olist_admin_senha = Column(String, nullable=False)
    olist_idfornecedor_padrao = Column(Integer, nullable=True)
    olist_iddeposito_padrao = Column(Integer, nullable=True)
    ...
    snk_admin_email = Column(String, nullable=False)
    snk_admin_senha = Column(String, nullable=False)
    snk_timeout_token_min = Column(Integer, nullable=False)    
    snk_top_pedido = Column(Integer, nullable=False)
    snk_top_venda = Column(Integer, nullable=False)
    snk_top_devolucao = Column(Integer, nullable=False)
    snk_codvend = Column(Integer, nullable=False)
    snk_codcencus = Column(Integer, nullable=False)
    snk_codnat = Column(Integer, nullable=False)
    snk_codtipvenda = Column(Integer, nullable=False)
    snk_codusu_integracao = Column(Integer, nullable=True)
    snk_codtab_transf = Column(Integer, nullable=True)
    snk_cod_local_estoque = Column(Integer, nullable=True)
