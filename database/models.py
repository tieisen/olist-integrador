...
class Empresa(Base):
    ...
    olist_id_categoria_despesa_padrao = Column(Integer, nullable=True)
    olist_id_categoria_taxa_padrao = Column(Integer, nullable=True)
    olist_id_categoria_frete_padrao = Column(Integer, nullable=True)
...
class Nota(Base):
    ...
    id_financeiro_taxa = Column(Integer, nullable=True)
    id_financeiro_frete = Column(Integer, nullable=True)
