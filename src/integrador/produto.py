...
class Produto:
    ...
    async def receber_alteracoes(self,**kwargs) -> bool:
        """
        Rotina de mapeamento das alterações do cadastro dos produtos no Olist
    ...
    @carrega_dados_empresa
    async def incluir_olist(self, produto:dict) -> bool:
        """
        Rotina de inclusão de novo produto no Olist
    ...
    @interno
    async def atualizar_olist(self, produto:dict) -> list:
        """
        Rotina de atualização de produto no Olist
            :param produto: dicionário com os dados do produto
            :return list: lista dos campos alterados no produto
        """          
    ...
    @carrega_dados_empresa
    @interno
    async def atualizar_sankhya(self, produto:dict) -> list:
        """
        Rotina de atualização de produto no Sankhya
            :param produto: dicionário com os dados do produto
            :return list: lista dos campos alterados no produto
        """            
    ...
    async def integrar_olist(self, **kwargs) -> bool:
        """
        Rotina integração de produto no Olist
            :return bool: status da operação
        """
        log_id = await crudLog.criar(empresa_id=self.dados_empresa.get('id'),
                                     de='sankhya',
    ...
    async def integrar_snk(self, **kwargs):
        """
        Rotina integração de produto no Sankhya
            :return bool: status da operação
        """        
        log_id = await crudLog.criar(empresa_id=self.dados_empresa.get('id'),
                                     de='olist',
