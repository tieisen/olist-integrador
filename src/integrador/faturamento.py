...
class Faturamento:
    ...
    def validar_quantidades_baixa_ecommerce(
            self,
            itens_pedidos:list[dict],
            itens_nota:list[dict]
        ) -> list[dict]:
    ...
    @carrega_dados_empresa
    async def desmembrar_lotes_baixa_ecommerce(
            self,
